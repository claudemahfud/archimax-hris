...
export const routes = [
  ...
  { path: ROUTES.HRD_KELOLA_KARYAWAN, component: lazy(() => import('../pages/hrd/kelola-karyawan')) },
  { path: ROUTES.HRD_KELOLA_KARYAWAN_EDIT, component: lazy(() => import('../pages/hrd/kelola-karyawan')) },
