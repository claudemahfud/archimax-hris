...
export const routes = [
  ...
  { path: ROUTES.HOD_PARAMETER_KPI, component: lazy(() => import('../pages/hod/parameter-kpi')) },
  ...
  { path: ROUTES.BM_PARAMETER_KPI, component: lazy(() => import('../pages/branch-manager/parameter-kpi')) },
