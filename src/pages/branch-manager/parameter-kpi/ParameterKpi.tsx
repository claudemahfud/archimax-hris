...
export default function ParameterKpi() {
  ...
  // ============================================================
  return (
    <AppShell portalTitle={`Portal Branch Manager — ${divisi}`} pageTitle="Kelola Parameter KPI" items={NAV_ITEMS} onKeluar={keluar}>
      ...
      {!uid ? (
        <p className="card">
          Fitur ini hanya tersedia untuk akun Branch Manager pribadi (login Username/Password). Superadmin yang sedang
