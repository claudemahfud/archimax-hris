...
export default function Penilaian() {
  ...
  return (
    <AppShell portalTitle={`Portal HOD — ${divisi}`} pageTitle="Form Penilaian KPI Staff" items={NAV_ITEMS} onKeluar={keluar}>
      ...
      {loading ? (
        ...
        <KpiForm targets={staffList} dinilaiOleh="HOD" onSubmitted={muat} aspekCustom={aspekCustom} />
      )}
    </AppShell>
  );
}
